const CACHE='forca50-v7';
const STATIC=['./manifest.webmanifest','./icon.svg','./style-v7.css?v=7','./app-v7.js?v=7'];
...
self.addEventListener('fetch',e=>{
  ...
  if(u.pathname.includes('/v7-')||u.pathname.endsWith('/app-v7.js')||u.pathname.endsWith('/style-v7.css')){
